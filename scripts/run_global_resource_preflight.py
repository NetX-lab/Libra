...
def parse_args():
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Use synthetic lengths only when no real profile/history JSONL is provided",
    )
...
def main():
    ...
    if args.history_jsonl:
        ...
        raise ValueError(
            "GRP preflight requires real history/profile data; pass --history-jsonl "
            "or explicitly enable --allow-synthetic-fallback"
        )
